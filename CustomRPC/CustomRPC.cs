...
namespace SuperNewRoles.CustomRPC
{
    ...
    public static class RPCProcedure
    {
        ...
        public static void MeetingSheriffKill(byte SheriffId, byte TargetId, bool MissFire)
        {
            ...
            {
                DestroyableSingleton<HudManager>.Instance.Chat.AddChat(sheriff, sheriff.name + "��" + target.name + "���V�F���t�L�������I");
                if (MissFire)
                {
                    DestroyableSingleton<HudManager>.Instance.Chat.AddChat(sheriff, sheriff.name + "�͌딚�����I");
                } else
                {
                    DestroyableSingleton<HudManager>.Instance.Chat.AddChat(sheriff, sheriff.name + "�͐��������I");
                }
            }
            if (MissFire)
            {
